...
final class LocalBridgeServer: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.miketoryan.Voice2028.local-bridge")
    ...
    private func parse(_ data: Data) -> ParseResult {
        ...
        guard headers["x-voice2028-protocol"] == LocalBridge.protocolVersion else {
            return .invalid
        }
    ...
    enum ServerError: LocalizedError {
        ...
        var errorDescription: String? {
            "Voice2028 local communication port is invalid."
        }
    }
