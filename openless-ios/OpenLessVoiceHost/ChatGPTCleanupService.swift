...
struct ChatGPTCleanupService {
    ...
    你是 OpenLess 的语音转录文本整理器。你的唯一任务是整理用户提供的转录文本。
    ...
    func clean(
        ...
        request.setValue("OpenLess", forHTTPHeaderField: "originator")
        request.setValue("OpenLess/0.2 (iOS)", forHTTPHeaderField: "User-Agent")
    ...
    enum CleanupError: LocalizedError {
        ...
        var errorDescription: String? {
            switch self {
            case .invalidResponse: "OpenLess received an invalid cleanup response."
            case .authenticationExpired: "ChatGPT authorization expired. Open OpenLess and sign in again."
