...
final class ChatGPTAuthManager: NSObject, ObservableObject, ASWebAuthenticationPresentationContextProviding {
    ...
    private enum Config {
        ...
        static let keychainAccount = "vocaphone.gpt.oauth"
    }
    ...
    private func save(_ credential: Credential) throws {
        ...
        try ChatGPTKeychainStore.save(data, account: Config.keychainAccount)
    }
    ...
    enum AuthError: LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .notSignedIn: "请先在 VocaPhone 中登录 ChatGPT。"
